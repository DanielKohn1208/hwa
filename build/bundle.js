var app = (function () {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.46.2 */
    ...
    /* src/Timer.svelte generated by Svelte v3.46.2 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-1g8mmy9");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-1g8mmy9");
    ...
    /* src/HowTo.svelte generated by Svelte v3.46.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands." class="svelte-oicxj"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/teams/integrated-health-services/infection-prevention-control">Picture source</a> 
	<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Effect</a>`;

    			t7 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="public_sound.wav"/>`;
    			attr(h1, "class", "svelte-1nykbwm");
    			attr(h3, "class", "svelte-1nykbwm");
    		},
    		m(target, anchor) {
